...
\usepackage{authblk}   
\title{AI-assisted metadata curation and agent-ready OPeNDAP access}
...
\textbf{Note}: We need this work to fall with the time between 1 July and the
end of the current EED3 contract which is Dec 31, 2026. Thus it is a six month project.

\textbf{Note 2}: I need to send a copy of this to Peter Plofchan at his RTX
email (peter.g.plofchan@rtx.com).
...
software engineering. {\em Hannah Robertson} will contribute agentic \acs{AI}
development and software engineering. {\em Miguel \`{A}ngel Jim\`{e}nez} will
collaborate on agentic \acs{AI} development, domain review, and testing as an
\acs{OPeNDAP}-funded contributor.
...
{\em Peter Cornillon} will contribute unfunded domain validation and testing as a
collaborator at the University of Rhode Island. Appendix~\ref{app-team} provides
Table~\ref{tab-team}, which summarizes the team members, effort, and
contributions.
