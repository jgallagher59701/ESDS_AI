...
software engineering. An {\em \ac{OPeNDAP} team member} will contribute agentic \acs{AI}
...
collaborator at \ac{OPeNDAP} and the University of Rhode Island. Appendix~\ref{app-team} provides
...
and software engineering. An {\em \ac{OPeNDAP} team member} will contribute to agentic AI
...
Miguel \`{A}ngel Jim\`{e}nez} will be funded by \ac{OPeNDAP} to collaborate with
an {\em \ac{OPeNDAP} team member} 
...
work described in the \texttt{grep-dap} project (Section~\ref{section-1.1}) and will provide
...
\hline
\ac{OPeNDAP} team member & 2 months & Agentic \ac{AI} development; software engineering \\
\hline
...
\hline
\ac{OPeNDAP} team member & \$199.07 & 2 & \$66,489 FIXME!! \\
\hline
